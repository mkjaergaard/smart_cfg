"""autogenerated by genmsg_py from DeployedComponentInfoRequest.msg. Do not edit."""
import roslib.message
import struct

import smart_cfg_server.msg

class DeployedComponentInfoRequest(roslib.message.Message):
  _md5sum = "35835d09ab31ab01f8b30f36891a6270"
  _type = "smart_cfg_server/DeployedComponentInfoRequest"
...
"""
  ...
  _slot_types = ['bool','smart_cfg_server/DeployedComponentID']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(DeployedComponentInfoRequest, self).__init__(*args, **kwds)
      #message fields cannot be None, assign default values for those that are
      if self.subscribe is None:
        self.subscribe = False
      if self.component_id is None:
        self.component_id = smart_cfg_server.msg.DeployedComponentID()
    else:
      self.subscribe = False
      self.component_id = smart_cfg_server.msg.DeployedComponentID()
