...
protected:
  ...
  IDeployedComponentPushReplyListener * deployed_component_manager_;
...
public:
  ...
  void setDeployedComponentManagerCallback( IDeployedComponentPushReplyListener * callback )
  {
  ...
  void triggerParameterValueReceivedNotify( const std::string& component_name, const ParameterIDAndValue& param )
  {
    ...
    {
      deployed_component_manager_->pushReplyReceivedNotify(component_name, param);
    }
  }
